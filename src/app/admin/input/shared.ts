...
export type Handlers = {
  handleScoreUpdate: (memberId: string, tab: MainTabType, val: number) => Promise<void>;
  handleIzumeAdd: (memberId: string, currentIzume: string[], result: string) => Promise<void>;
  handleIzumePop: (memberId: string, currentIzume: string[]) => Promise<void>;
  handleEnkinUpdate: (memberId: string, val: string) => Promise<void>;
};
...
export const MAIN_TABS = [
  { id: "yosen", label: "🎯 予選", desc: "0〜4中入力" },
  { id: "team_kessho", label: "🏆 団体決勝", desc: "0〜2中入力" },
  { id: "team_izume", label: "⚔️ 団体射詰", desc: "同中競射" },
  { id: "confirm", label: "📋 成績確認", desc: "団体射詰結果" },
  { id: "ind_kessho", label: "⚔️ 個人決勝", desc: "射詰・遠近入力" },
